/********************************************************************
 * CONTACT MODULE – analog zu skills.js / cv.js / stories.js
 * Kein this, kein fetch, kein innerHTML
 ********************************************************************/
...
export const contact = {
  ...
  /**************************************************************
   * init() – baut DOM-Struktur auf und wendet Sprache an
   **************************************************************/
  init() {
    contact._render();
  ...
  /**************************************************************
   * load(lang)
   * wird von i18n aufgerufen, wenn Sprache gewechselt wird
   **************************************************************/
  load(lang) {
    contact._render();
    language.applyTexts(contact._containerId);
  ...
  /**************************************************************
   * _render()
   * erzeugt DOM-Struktur mit IDs für i18n-Zuordnung
   **************************************************************/
  _render() {
